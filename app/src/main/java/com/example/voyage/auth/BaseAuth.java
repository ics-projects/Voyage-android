...
public interface BaseAuth<T> {
    BehaviorSubject<VoyageUser> signInWithEmailAndPassword(String email, String password);

    BehaviorSubject<VoyageUser> createUserWithCredentials(String firstName, String lastName, String email,
